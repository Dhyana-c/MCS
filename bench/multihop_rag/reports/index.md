...
| [agent_vs_framework_investigation.md](agent_vs_framework_investigation.md) | 2026-06-24 | 上者的**完整调查报告**：召回/排序拆分、建图非瓶颈审计、闭卷泄漏探针、null 诚实性、差因、成本、两条可移植杠杆 → proposal `focused-candidate-selection` |
